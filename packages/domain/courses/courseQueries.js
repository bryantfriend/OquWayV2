import { getActiveAssignmentsForStudent } from "../assignments/index.js?v=1.1.89-student-fruit-session";

export { buildStudentAssignmentTargets } from "../assignments/index.js?v=1.1.89-student-fruit-session";
