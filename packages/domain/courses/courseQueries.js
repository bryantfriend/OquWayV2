import { getActiveAssignmentsForStudent } from "../assignments/index.js?v=1.1.110-student-class-alias-query";

export { buildStudentAssignmentTargets } from "../assignments/index.js?v=1.1.110-student-class-alias-query";
