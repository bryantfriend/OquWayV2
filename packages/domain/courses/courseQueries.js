import { getActiveAssignmentsForStudent } from "../assignments/index.js?v=1.1.102-student-profile-payload";

export { buildStudentAssignmentTargets } from "../assignments/index.js?v=1.1.102-student-profile-payload";
