...
import { getMultipleChoiceDefaultContent, normalizeMultipleChoiceConfig, validateMultipleChoiceConfig } from "./multipleChoice.schema.js?v=1.1.226-learning-activity-files";
