import { validateAuthenticated, validateTeacherClassPayload } from "../../stages/validate/validators.js?v=1.1.80-course-module-command-center";
...
import { processLoadTeacherStudents } from "../../stages/process/processors.js?v=1.1.80-course-module-command-center";
