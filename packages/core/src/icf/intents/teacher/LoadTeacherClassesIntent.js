import { validateAuthenticated } from "../../stages/validate/validators.js?v=1.1.42-teacher-scoped-queries";
...
import { processLoadTeacherClasses } from "../../stages/process/processors.js?v=1.1.42-teacher-scoped-queries";
