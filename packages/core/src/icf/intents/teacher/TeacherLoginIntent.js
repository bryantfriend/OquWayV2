import { validateTeacherLoginPayload } from "../../stages/validate/validators.js?v=1.1.125-teacher-dashboard-login";
import { normalizeTeacherLoginPayload } from "../../stages/normalize/normalizers.js?v=1.1.125-teacher-dashboard-login";
import { allowTeacherLoginAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.125-teacher-dashboard-login";
import { processTeacherLogin } from "../../stages/process/processors.js?v=1.1.125-teacher-dashboard-login";
