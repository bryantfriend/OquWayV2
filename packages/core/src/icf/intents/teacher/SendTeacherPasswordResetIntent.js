import { validateTeacherPasswordResetPayload } from "../../stages/validate/validators.js?v=1.1.35-teacher-dashboard";
import { normalizeTeacherPasswordResetPayload } from "../../stages/normalize/normalizers.js?v=1.1.35-teacher-dashboard";
import { allowTeacherLoginAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.35-teacher-dashboard";
import { processSendTeacherPasswordReset } from "../../stages/process/processors.js?v=1.1.35-teacher-dashboard";
