import { validateAuthenticated, validateTeacherReviewQueuePayload } from "../../stages/validate/validators.js?v=1.1.116-student-token-ready";
...
import { processLoadTeacherCourseDetail } from "../../stages/process/processors.js?v=1.1.116-student-token-ready";
