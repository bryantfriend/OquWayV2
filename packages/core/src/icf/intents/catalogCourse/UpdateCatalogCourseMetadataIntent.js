...
import { attachUpdatedByContext } from "../../stages/addContext/contexts.js?v=1.1.219-course-creator-all-courses";
import { attachCourseDocument } from "../../stages/addContext/contexts.js?v=1.1.219-course-creator-all-courses";
