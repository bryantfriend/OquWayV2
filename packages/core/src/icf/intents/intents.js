...
export { CreateClassIntent } from "./superAdmin/CreateClassIntent.js?v=1.1.54-multi-role-assistant";
...
export { ListClassesIntent } from "./superAdmin/ListClassesIntent.js?v=1.1.54-multi-role-assistant";
...
export { UpdateClassIntent } from "./superAdmin/UpdateClassIntent.js?v=1.1.54-multi-role-assistant";
