import { validateAuthenticated, validateLocationPayload } from "../../stages/validate/validators.js?v=1.1.78-location-command-center";
import { normalizeLocationPayload } from "../../stages/normalize/normalizers.js?v=1.1.78-location-command-center";
...
import { processCreateLocation } from "../../stages/process/processors.js?v=1.1.78-location-command-center";
