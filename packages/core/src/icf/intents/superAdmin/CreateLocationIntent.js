import { validateAuthenticated, validateLocationPayload } from "../../stages/validate/validators.js?v=1.1.113-student-rules-read";
...
import { processCreateLocation } from "../../stages/process/processors.js?v=1.1.113-student-rules-read";
