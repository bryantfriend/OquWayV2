import { validateAuthenticated, validateLocationUpdatePayload } from "../../stages/validate/validators.js?v=1.1.116-student-token-ready";
import { normalizeLocationPayload } from "../../stages/normalize/normalizers.js?v=1.1.116-student-token-ready";
...
import { processUpdateLocation } from "../../stages/process/processors.js?v=1.1.116-student-token-ready";
