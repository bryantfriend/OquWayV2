import { validateAuthenticated, validateClassPayload } from "../../stages/validate/validators.js?v=1.1.79-user-command-center";
...
import { processCreateClass } from "../../stages/process/processors.js?v=1.1.79-user-command-center";
