import { validateAuthenticated, validateClassPayload } from "../../stages/validate/validators.js?v=1.1.82-shared-command-center-shell";
...
import { processCreateClass } from "../../stages/process/processors.js?v=1.1.82-shared-command-center-shell";
