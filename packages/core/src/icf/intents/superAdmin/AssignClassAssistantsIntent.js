...
import { requireClassOwnershipAdminAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.82-shared-command-center-shell";
import { processAssignClassAssistants } from "../../stages/process/processors.js?v=1.1.82-shared-command-center-shell";
