import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.80-course-module-command-center";
import { normalizeClassPayload } from "../../stages/normalize/normalizers.js?v=1.1.80-course-module-command-center";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.80-course-module-command-center";
