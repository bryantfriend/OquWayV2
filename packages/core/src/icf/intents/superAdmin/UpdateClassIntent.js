import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.78-location-command-center";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.78-location-command-center";
