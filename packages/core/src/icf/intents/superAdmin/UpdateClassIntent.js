import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.29-module-render-fix";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.29-module-render-fix";
