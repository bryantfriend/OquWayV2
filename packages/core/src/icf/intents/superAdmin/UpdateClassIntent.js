import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.162-modal-stack";
import { normalizeClassPayload } from "../../stages/normalize/normalizers.js?v=1.1.162-modal-stack";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.162-modal-stack";
