import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.62-external-task-review-loop";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.62-external-task-review-loop";
