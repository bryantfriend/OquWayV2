import { validateAuthenticated, validateClassUpdatePayload } from "../../stages/validate/validators.js?v=1.1.117-student-identity-binding";
...
import { processUpdateClass } from "../../stages/process/processors.js?v=1.1.117-student-identity-binding";
