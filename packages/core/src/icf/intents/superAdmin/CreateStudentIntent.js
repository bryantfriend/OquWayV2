import { validateAuthenticated, validateStudentPayload } from "../../stages/validate/validators.js?v=1.1.108-student-class-alias-merge";
...
import { processCreateStudent } from "../../stages/process/processors.js?v=1.1.108-student-class-alias-merge";
