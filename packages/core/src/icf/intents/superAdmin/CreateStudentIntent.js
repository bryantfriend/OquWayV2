import { validateAuthenticated, validateStudentPayload } from "../../stages/validate/validators.js?v=1.1.81-class-command-center";
...
import { processCreateStudent } from "../../stages/process/processors.js?v=1.1.81-class-command-center";
