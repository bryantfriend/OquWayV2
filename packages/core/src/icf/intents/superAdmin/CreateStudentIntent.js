import { validateAuthenticated, validateStudentPayload } from "../../stages/validate/validators.js?v=1.1.124-location-icon-upload";
...
import { processCreateStudent } from "../../stages/process/processors.js?v=1.1.124-location-icon-upload";
