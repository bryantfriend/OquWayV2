import { validateAuthenticated, validateStudentUpdatePayload } from "../../stages/validate/validators.js?v=1.1.124-location-icon-upload";
import { normalizeStudentPayload } from "../../stages/normalize/normalizers.js?v=1.1.124-location-icon-upload";
...
import { processUpdateStudent } from "../../stages/process/processors.js?v=1.1.124-location-icon-upload";
