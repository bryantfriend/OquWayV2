import { validateAuthenticated, validateStudentUpdatePayload } from "../../stages/validate/validators.js?v=1.1.78-location-command-center";
import { normalizeStudentPayload } from "../../stages/normalize/normalizers.js?v=1.1.78-location-command-center";
...
import { processUpdateStudent } from "../../stages/process/processors.js?v=1.1.78-location-command-center";
