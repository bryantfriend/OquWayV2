import { validateAuthenticated, validateStudentUpdatePayload } from "../../stages/validate/validators.js?v=1.1.54-multi-role-assistant";
...
import { processUpdateStudent } from "../../stages/process/processors.js?v=1.1.54-multi-role-assistant";
