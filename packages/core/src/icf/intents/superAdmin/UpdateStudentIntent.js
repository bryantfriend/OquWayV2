import { validateAuthenticated, validateStudentUpdatePayload } from "../../stages/validate/validators.js?v=1.1.79-user-command-center";
...
import { processUpdateStudent } from "../../stages/process/processors.js?v=1.1.79-user-command-center";
