import { validateAuthenticated, validateFruitPasswordResetPayload } from "../../stages/validate/validators.js?v=1.1.29-module-render-fix";
import { normalizeFruitPasswordResetPayload } from "../../stages/normalize/normalizers.js?v=1.1.29-module-render-fix";
...
import { processResetStudentFruitPassword } from "../../stages/process/processors.js?v=1.1.29-module-render-fix";
