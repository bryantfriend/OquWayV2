import { validateAuthenticated, validateCourseAssignmentPayload } from "../../stages/validate/validators.js?v=1.1.56-assignment-ownership";
import { normalizeCourseAssignmentPayload } from "../../stages/normalize/normalizers.js?v=1.1.56-assignment-ownership";
...
import { processCreateCourseAssignment } from "../../stages/process/processors.js?v=1.1.56-assignment-ownership";
