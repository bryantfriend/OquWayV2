...
import { attachCourseDocumentForModule, attachModuleDocument, attachSessionsCollection } from "../../stages/addContext/contexts.js?v=1.1.124-location-icon-upload";
import { processOpenModuleEditor } from "../../stages/process/processors.js?v=1.1.124-location-icon-upload";
