...
import { attachCourseDocumentForModule, attachModuleDocument, attachSessionsCollection } from "../../stages/addContext/contexts.js?v=1.1.116-student-token-ready";
import { processOpenModuleEditor } from "../../stages/process/processors.js?v=1.1.116-student-token-ready";
