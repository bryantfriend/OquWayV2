...
import { attachActorContext, attachActorRoleContext, attachCourseDocumentForModule, attachModuleDocument, attachSessionDocument } from "../../stages/addContext/contexts.js?v=1.1.185-ready-templates";
import { requireCourseCreatorAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.185-ready-templates";
import { processAddStepToPracticeMode } from "../../stages/process/processors.js?v=1.1.185-ready-templates";
