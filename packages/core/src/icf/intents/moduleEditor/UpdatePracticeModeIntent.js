import { validateAuthenticated, validateCourseId, validateModuleId, validatePracticeModeKey, validateSessionId } from "../../stages/validate/validators.js?v=1.1.82-shared-command-center-shell";
import { normalizeCourseId, normalizePracticeModeMetadata } from "../../stages/normalize/normalizers.js?v=1.1.82-shared-command-center-shell";
...
import { processUpdatePracticeMode } from "../../stages/process/processors.js?v=1.1.82-shared-command-center-shell";
