...
import { normalizeCourseId, normalizePracticeModeMetadata } from "../../stages/normalize/normalizers.js?v=1.1.54-multi-role-assistant";
...
import { processUpdatePracticeMode } from "../../stages/process/processors.js?v=1.1.54-multi-role-assistant";
