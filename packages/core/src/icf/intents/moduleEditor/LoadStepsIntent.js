import { validateAuthenticated, validateCourseId, validateModuleId, validateSessionId, validatePracticeModeKey } from "../../stages/validate/validators.js?v=1.1.124-location-icon-upload";
...
import { processLoadSteps } from "../../stages/process/processors.js?v=1.1.124-location-icon-upload";
