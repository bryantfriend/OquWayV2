import { validateAuthenticated, validateCourseId, validateModuleId, validateSessionId } from "../../stages/validate/validators.js?v=1.1.120-student-course-debug-summary";
...
import { processCreatePracticeModeShells } from "../../stages/process/processors.js?v=1.1.120-student-course-debug-summary";
