import { validateAuthenticated, validateCourseId, validateLearningModeId, validateModuleId, validatePracticeModeStepId } from "../../stages/validate/validators.js?v=1.1.117-student-identity-binding";
...
import { processUpdateLearningModeStep } from "../../stages/process/processors.js?v=1.1.117-student-identity-binding";
