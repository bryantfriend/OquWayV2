import { validateAuthenticated, validateCourseId, validateOrderBounds } from "../../stages/validate/validators.js?v=1.1.110-student-class-alias-query";
...
import { attachCourseDocument, attachModulesCollection } from "../../stages/addContext/contexts.js?v=1.1.110-student-class-alias-query";
import { requireCourseCreatorAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.110-student-class-alias-query";
import { processReorderModules } from "../../stages/process/processors.js?v=1.1.110-student-class-alias-query";
