import { validateAuthenticated, validateCourseId, validateOrderBounds } from "../../stages/validate/validators.js?v=1.1.124-location-icon-upload";
...
import { processReorderModules } from "../../stages/process/processors.js?v=1.1.124-location-icon-upload";
