...
import { normalizeCourseId, normalizeModuleShell } from "../../stages/normalize/normalizers.js?v=1.1.116-student-token-ready";
...
import { attachModuleDocument } from "../../stages/addContext/contexts.js?v=1.1.116-student-token-ready";
import { requireCourseCreatorAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.116-student-token-ready";
import { processUpdateModule } from "../../stages/process/processors.js?v=1.1.116-student-token-ready";
