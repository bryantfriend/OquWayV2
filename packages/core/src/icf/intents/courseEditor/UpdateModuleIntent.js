...
import { attachModuleDocument } from "../../stages/addContext/contexts.js?v=1.1.62-external-task-review-loop";
import { requireCourseCreatorAuthorization } from "../../stages/authorize/authorizers.js?v=1.1.62-external-task-review-loop";
import { processUpdateModule } from "../../stages/process/processors.js?v=1.1.62-external-task-review-loop";
