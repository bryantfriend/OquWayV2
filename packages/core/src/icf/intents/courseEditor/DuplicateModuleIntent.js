import { validateAuthenticated, validateCourseId, validateModuleExists } from "../../stages/validate/validators.js?v=1.1.81-class-command-center";
...
import { processDuplicateModule } from "../../stages/process/processors.js?v=1.1.81-class-command-center";
