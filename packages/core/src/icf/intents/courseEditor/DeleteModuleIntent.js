import { validateAuthenticated, validateCourseId, validateModuleExists } from "../../stages/validate/validators.js?v=1.1.108-student-class-alias-merge";
...
import { processDeleteModule } from "../../stages/process/processors.js?v=1.1.108-student-class-alias-merge";
