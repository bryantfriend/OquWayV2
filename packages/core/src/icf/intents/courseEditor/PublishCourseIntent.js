import { validateAuthenticated, validateCourseId, validateCoursePublishReady } from "../../stages/validate/validators.js?v=1.1.29-module-render-fix";
...
import { processPublishCourse } from "../../stages/process/processors.js?v=1.1.29-module-render-fix";
