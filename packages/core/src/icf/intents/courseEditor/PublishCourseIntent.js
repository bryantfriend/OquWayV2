import { validateAuthenticated, validateCourseId, validateCoursePublishReady } from "../../stages/validate/validators.js?v=1.1.81-class-command-center";
...
import { processPublishCourse } from "../../stages/process/processors.js?v=1.1.81-class-command-center";
