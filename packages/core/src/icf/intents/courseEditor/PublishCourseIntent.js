import { validateAuthenticated, validateCourseId, validateCoursePublishReady } from "../../stages/validate/validators.js?v=1.1.113-student-rules-read";
...
import { processPublishCourse } from "../../stages/process/processors.js?v=1.1.113-student-rules-read";
