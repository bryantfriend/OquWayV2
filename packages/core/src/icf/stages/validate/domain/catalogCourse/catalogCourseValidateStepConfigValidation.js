import { requireStringValidation } from "../../validators.js?v=1.1.228-learning-activity-drag-interactions";
import { requireNonEmptyArrayValidation } from "../../validators.js?v=1.1.228-learning-activity-drag-interactions";
import { requireEnumValidation } from "../../validators.js?v=1.1.228-learning-activity-drag-interactions";
import { requireUUIDValidation } from "../../validators.js?v=1.1.228-learning-activity-drag-interactions";
import { isSupportedStepType, normalizeStepType } from "../../../../../shared/stepTypes/stepTypeRegistry.js?v=1.1.228-learning-activity-drag-interactions";
