import { db, collection, doc, getDoc, getDocs } from "../../../../../infrastructure/firebase/firestore.js?v=1.1.94-student-profile-context";
import { normalizePracticeModes } from "../moduleEditor/practiceModeShells.js?v=1.1.94-student-profile-context";
import { getAssignedCourseIds } from "../../../../../../../domain/courses/index.js?v=1.1.94-student-profile-context";
import { getStudentExternalTaskSubmissions } from "../../../../../../../domain/externalTasks/index.js?v=1.1.94-student-profile-context";
import { isStudentDashboardProfile, readStudentClassIds, readStudentLocationIds, readStudentProfileRejectReason } from "../../../../../../../domain/users/index.js?v=1.1.94-student-profile-context";
import { createDefaultProgressDocument } from "./studentProgressHelpers.js?v=1.1.94-student-profile-context";
