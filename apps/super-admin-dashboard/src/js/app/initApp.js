...
import { registerIntentDefinitions, runAdminIntent } from "../icf/intentRegistry.js?v=1.1.56-assignment-ownership";
...
export async function initApp() {
  ...
  await import("./legacyDashboard.js?v=1.1.56-assignment-ownership");
