import {
    ...
    getUserRoles,
    normalizeUserRole
} from "../../../../packages/domain/users/index.js?v=1.1.138-course-overview-title";
import { canAccessCourseCreator } from "../../../../packages/permissions/index.js?v=1.1.138-course-overview-title";
