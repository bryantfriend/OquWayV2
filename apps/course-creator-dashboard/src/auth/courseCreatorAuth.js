import {
    ...
    getUserRoles,
    normalizeUserRole
} from "../../../../packages/domain/users/index.js?v=1.1.216-student-dashboard-staff-login";
import { canAccessCourseCreator } from "../../../../packages/permissions/index.js?v=1.1.216-student-dashboard-staff-login";
