import { catalogCourseService } from "../services/catalogCourseService.js?v=1.1.116-student-token-ready";
import { courseCreatorStore } from "../state/courseCreatorState.js?v=1.1.116-student-token-ready";
