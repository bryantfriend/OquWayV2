import { catalogCourseService } from "../services/catalogCourseService.js?v=1.1.117-student-identity-binding";
import { courseCreatorStore } from "../state/courseCreatorState.js?v=1.1.117-student-identity-binding";
