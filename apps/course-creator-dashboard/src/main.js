import { OQUWAY_BUILD_VERSION } from "../../../packages/shared/version.js?v=1.1.166-reveal-card-editor";
...
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.166-reveal-card-editor";
