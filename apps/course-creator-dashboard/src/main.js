import { OQUWAY_BUILD_VERSION } from "../../../packages/shared/version.js?v=1.1.177-level-unlock-roadmap";
...
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.177-level-unlock-roadmap";
