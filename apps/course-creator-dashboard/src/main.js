...
import { verifyCourseCreatorAccess, normalizeRole } from "./auth/courseCreatorAuth.js?v=1.1.113-student-rules-read";
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.113-student-rules-read";
import { StepPreviewPage } from "./ui/pages/StepPreviewPage.js?v=1.1.113-student-rules-read";
import { CatalogCoursePage } from "./ui/pages/CatalogCoursePage.js?v=1.1.113-student-rules-read";
import { CourseOverviewPage } from "./ui/pages/CourseOverviewPage.js?v=1.1.113-student-rules-read";
import { LocationLoginSettingsPage } from "./ui/pages/LocationLoginSettingsPage.js?v=1.1.113-student-rules-read";
