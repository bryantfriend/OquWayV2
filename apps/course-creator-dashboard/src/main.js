...
import { verifyCourseCreatorAccess, normalizeRole } from "./auth/courseCreatorAuth.js?v=1.1.79-user-command-center";
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.79-user-command-center";
import { StepPreviewPage } from "./ui/pages/StepPreviewPage.js?v=1.1.79-user-command-center";
import { CatalogCoursePage } from "./ui/pages/CatalogCoursePage.js?v=1.1.79-user-command-center";
import { CourseOverviewPage } from "./ui/pages/CourseOverviewPage.js?v=1.1.79-user-command-center";
import { LocationLoginSettingsPage } from "./ui/pages/LocationLoginSettingsPage.js?v=1.1.79-user-command-center";
