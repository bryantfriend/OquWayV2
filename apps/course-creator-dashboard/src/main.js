...
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.192-timed-sequence";
import { StepPreviewPage } from "./ui/pages/StepPreviewPage.js?v=1.1.192-timed-sequence";
