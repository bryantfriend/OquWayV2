import { OQUWAY_BUILD_VERSION } from "../../../packages/shared/version.js?v=1.1.182-step-title-hydration";
...
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.182-step-title-hydration";
