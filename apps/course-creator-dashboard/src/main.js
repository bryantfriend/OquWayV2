...
import { CourseEditorPage } from "./ui/pages/CourseEditorPage.js?v=1.1.185-ready-templates";
import { StepPreviewPage } from "./ui/pages/StepPreviewPage.js?v=1.1.185-ready-templates";
