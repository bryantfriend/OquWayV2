...
import { OQUWAY_BUILD_VERSION } from "../../../packages/shared/version.js?v=1.1.102-student-profile-payload";
import { auth } from "../../../packages/firebase/auth/index.js?v=1.1.102-student-profile-payload";
import { PracticeModePlayer } from "../../../packages/shared/player/index.js?v=1.1.102-student-profile-payload";
import {
...
} from "../../../packages/domain/progress/index.js?v=1.1.102-student-profile-payload";
import {
  createEmptyState,
  createErrorState,
  createLoadingState,
  createStatusBadge,
  formatStatusLabel
} from "../../../packages/ui/index.js?v=1.1.102-student-profile-payload";
import { studentDashboardStore } from "./ui/state/studentDashboardState.js?v=1.1.102-student-profile-payload";
import { studentDashboardService } from "./ui/services/studentDashboardService.js?v=1.1.102-student-profile-payload";
