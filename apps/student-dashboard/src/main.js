...
import { OQUWAY_BUILD_VERSION } from "../../../packages/shared/version.js?v=1.1.88-student-course-assignment-trace";
import { auth } from "../../../packages/firebase/auth/index.js?v=1.1.88-student-course-assignment-trace";
import { PracticeModePlayer } from "../../../packages/shared/player/index.js?v=1.1.88-student-course-assignment-trace";
import {
...
} from "../../../packages/domain/progress/index.js?v=1.1.88-student-course-assignment-trace";
import {
  createEmptyState,
  createErrorState,
  createLoadingState,
  createStatusBadge,
  formatStatusLabel
} from "../../../packages/ui/index.js?v=1.1.88-student-course-assignment-trace";
import { studentDashboardStore } from "./ui/state/studentDashboardState.js?v=1.1.88-student-course-assignment-trace";
import { studentDashboardService } from "./ui/services/studentDashboardService.js?v=1.1.88-student-course-assignment-trace";
