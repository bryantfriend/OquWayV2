...
import { PracticeModePlayer } from "../../../packages/shared/player/index.js?v=1.1.148-student-course-title";
import {
...
} from "../../../packages/domain/progress/index.js?v=1.1.148-student-course-title";
import {
  createEmptyState,
  createErrorState,
  createLoadingState,
  createStatusBadge,
  formatStatusLabel
} from "../../../packages/ui/index.js?v=1.1.148-student-course-title";
import { studentDashboardStore } from "./ui/state/studentDashboardState.js?v=1.1.148-student-course-title";
import { studentDashboardService } from "./ui/services/studentDashboardService.js?v=1.1.148-student-course-title";
