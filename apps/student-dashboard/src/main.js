...
import { PracticeModePlayer } from "../../../packages/shared/player/index.js?v=1.1.89-student-fruit-session";
import {
...
} from "../../../packages/domain/progress/index.js?v=1.1.89-student-fruit-session";
import {
  createEmptyState,
  createErrorState,
  createLoadingState,
  createStatusBadge,
  formatStatusLabel
} from "../../../packages/ui/index.js?v=1.1.89-student-fruit-session";
import { studentDashboardStore } from "./ui/state/studentDashboardState.js?v=1.1.89-student-fruit-session";
import { studentDashboardService } from "./ui/services/studentDashboardService.js?v=1.1.89-student-fruit-session";
