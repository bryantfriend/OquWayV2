...
import { auth } from "../../../../../packages/firebase/auth/index.js?v=1.1.128-teacher-query-fallbacks";
import { getIntentDefinition, runIntentPipeline } from "../../../../../packages/icf/index.js?v=1.1.128-teacher-query-fallbacks";
