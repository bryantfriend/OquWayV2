...
import { auth } from "../../../../../packages/firebase/auth/index.js?v=1.1.129-teacher-query-noise";
import { getIntentDefinition, runIntentPipeline } from "../../../../../packages/icf/index.js?v=1.1.129-teacher-query-noise";
